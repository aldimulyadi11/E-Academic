              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  @endif
                    ...
                    <form action="{{ url('/registerTambahFakultas') }}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    {{ csrf_field() }}                   
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input autocomplete="off" name="nama_fak" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <select class="form-control" name="dekan">
                            @foreach($tamp as $data)
                              <option value="{{$data->nidn}}">{{$data->nama_dosen}} .,{{ $data -> gelar }}</option>
                            @endforeach
                          </select>
