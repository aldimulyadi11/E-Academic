                        ...
                        <table id="datatable"  class="table table-striped table-bordered">
                          ...
                          @foreach($nilai as $data)  
                            ...
                            <tr>
                              ...
                              <form action="{{ url('/registerTambahNilaiUts/'.$data->id_matkul) }}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                              {{ csrf_field() }}                                                           
                              <td><input style="width: 25%;" type="number" name="uts"></td>
                              <td>
